class ExS3Edit < Formula
  ...
  if OS.mac?
    if Hardware::CPU.intel?
      ...
      sha256 "376ed0f541f59993291297a8ff074cac33e794cb230d7b21e3a28eed6e90fb2a"
    else
      url "https://github.com/joegiralt/ex-s3-edit/releases/download/v0.1.0/ex-s3-edit_0.1.0_darwin_arm_m1.tar.gz"
